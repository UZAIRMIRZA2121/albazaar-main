            ...
            <section class="col-lg-9 __customer-profile px-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-inner">
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <input class="form-control" id="phone" type="text"
                                                value="{{ $userPhone }}"
                                                placeholder="{{ translate('enter_phone_number') }}" required name="phone"
                            ...
                            <script>
                                document.getElementById('profile_form').addEventListener('submit', function(e) {
                                    ...
                                    const saudiPattern = /^(00966|966|\+966|0)?5\d{8}$/;

                                    if (!saudiPattern.test(phoneInput.value)) {
                                ...
                                function validateSaudiPhone(input) {
                                    ...
                                    if (!saudiPattern.test(input.value)) {
                                        phoneError.style.display = "block";
                                    } else {
                                        phoneError.style.display = "none";
                                    }
                        ...
                        <small id="phoneError" style="color:red;display:none;">Please enter a valid Saudi phone
                            number.</small>

                    </div>
                    <div class="form-group col-md-6 mb-0">
                        <label for="inputEmail4" class="mb-2 text-capitalize">{{ translate('email') }} </label>
                        <div class="position-relative d-flex align-items-center">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <label for="si-password" class="mb-2 text-capitalize">{{ translate('new_password') }}</label>
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <label for="newPass" class="mb-2 text-capitalize">{{ translate('confirm_password') }} </label>
                        <div class="password-toggle rtl">
