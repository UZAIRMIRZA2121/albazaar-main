        ...
        <div class="container rtl">
            <div class="row">
                <div class="col-md-12 sidebar_heading text-center mb-2">
                    <h1 class="text-center pt-4 fs-24 font-semi-bold text-capitalize">
                        {{ translate('frequently_asked_question') }}</h1>
                </div>
            </div>
            <hr>
        </div>
                                        ...
                                        @for ($i = 0; $i < $first; $i++)
                                            <div id="accordion">
                                                <div class="row mb-0 text-black">
                                                    ...
                                                    <div class="col-11">
                                                        <button class="btnF btn-link collapsed text-align-direction"
                                                            data-toggle="collapse"
                                                            data-target="#collapseTwo{{ $helps[$i]['id'] }}"
                                                            aria-expanded="false" aria-controls="collapseTwo">
                                                            <span
                                                                class="d-flex align-items-center border-bottom pb-3 mb-3">{{ $helps[$i]['question'] }}</span>
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-center align-items-center pt-4">
                            <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                                ...
                                <h5 class="text-muted fs-14 font-semi-bold text-center">{{ translate('there_is_no_FAQs') }}
                                </h5>
                            </div>
                        </div>
                    </div>
