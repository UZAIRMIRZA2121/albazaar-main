                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8">
                                <div class="text-center">
                                    ...
                                    <a class="fw-bold btn btn-primary" id="modelOpen" data-toggle="modal" data-target="#signInModal" href="{{route('vendor.auth.login')}}">Get Started</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-4">
                                                ...
                                                <input class="form-control rounded" type="email" id="email" name="email" placeholder="{{translate('Ex: example@gmail.com')}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-4">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control rounded" id="email_add" placeholder="Enter your email" required>
                        <span class="email_validation text-danger"></span>
                    </div>
                    <button type="button" class="btn btn-dark w-100 rounded-pill" id="toModal2" >Continue</button>
                    <p class="text-center mt-3">Trouble Signing In?</p>
                    <div class="text-center">
                        
                        <a  href="{{ route('vendor.auth.login.google') }}" class="btn btn-social w-100 border rounded-pill my-1">
                            <img width="25"  src="https://img.icons8.com/color/48/google-logo.png" alt="google-logo"/>
                            Continue with Google
                        </a>
                        <a  href="{{ route('vendor.auth.login.facebook') }}" class="btn btn-social w-100 border rounded-pill my-1">
                            <img width="25"  src="https://img.icons8.com/fluency/48/facebook-new.png" alt="facebook-new"/>
                            Continue with Facebook
                        </a>
                        <button type="button" class="btn btn-social w-100 border rounded-pill my-1">
                            <img width="25"  src="https://img.icons8.com/ios-filled/50/mac-os.png" alt="mac-os"/>
                            Continue with Apple
                        </button>
                    </div>
                    <p class="text-center mt-3">Albazar may send you communications. Change preferences in your account settings. We'll never post without your permission.</p>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="createAccountModal" tabindex="-1" aria-labelledby="createAccountModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <span id="backToSignIn" class="flex items-center text-gray-600 hover:text-gray-800 transition-all cursor-pointer">
            ...
            <div class="modal-body">
                <form>
                    <div class="text-center">
                        ...
                        <img src="{{theme_asset('assets/front-end/img/icons/user-vector.svg')}}" alt="Vendor Avatar" class="mb-3" style="width: 50px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control rounded" id="name_vendor" placeholder="Enter your name">
                        <span id="name_error" class="text-danger" style="display: none;">Please enter your name</span>

                    </div>

                    <div class="form-group">
                        <label for="phone">Phone Number</label>
                        <input type="tel" class="form-control rounded" id="phone_vendor" placeholder="Enter your phone number">
                        <span id="phone_error" class="text-danger" style="display: none;">Please enter your phone number</span>

                    </div>
                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" class="form-control rounded" id="password_vendor" placeholder="Enter your password">
                        <span id="password_error" class="text-danger" style="display: none;">Password is required</span>

                    </div>
                    <div class="form-group">
                        <label for="confirm-password">Confirm Password</label>
                        <input type="password" class="form-control rounded" id="confirm_password_vendor" placeholder="Confirm your password">
                        <span id="confirm_password_error" class="text-danger" style="display: none;">Passwords do not match</span>

                    </div>
                    <button type="button" class="btn btn-dark w-100 rounded-pill" id=""   onclick="validateForm()">Continue</button>
                    <p class="text-center mt-3">Albazar may send you communications. Change preferences in your account settings. We'll never post without your permission.</p>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="accountVerificationModal" tabindex="-1" aria-labelledby="accountVerificationModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group">
                        <input type="text" class="form-control rounded" placeholder="Enter the 6-digit code">
                    </div>
                    <button class="btn btn-dark w-100 rounded-pill proceed-to-next">Continue</button>
                    <p class="text-center mt-3">Didn't get a code? Resend</p>
                </form>
            </div>
        </div>
    </div>
