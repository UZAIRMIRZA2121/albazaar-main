...
@section('content')
    ...
    {{-- hero section --}}
    <div
        class="container-fluid mx-auto bg-[#FFEEE6] bg-[url('{{ asset('footer/06.07.2025_06.56.41_REC.png') }}')] bg-no-repeat bg-cover bg-center  md:pb-[30px] pb-[10px] md:pt-[50px] pt-[20px]  md:block">
    ...
    <div class="md:py-10 px-2">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6 mx-3">
          ...
          <a href="#" class="hidden md:inline-block text-orange-600 font-medium text-sm hover:underline">View all</a>
        </div>
          ...
          @foreach ($featuredProductsList as $product)
            <a href="{{ route('product', $product->slug) }}" class="block">
              <div class="rounded-xl overflow-hidden text-center p-1 bg-white group relative">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-200 z-10">
                  <button
                ...
                <div class="px-4 py-3">
                  ...
                  <p class="text-orange-500 font-semibold mt-2">{{ $product->price ?? 'SAR0.00' }}</p>
                </div>
              </div>
            </a>
          @endforeach
        ...
        <a href="#" class="md:hidden text-orange-600 text-[16px] underline hover:text-orange-700 transition duration-200 text-center block my-5">
          View all
        </a>
      </div>
    </div>
...
@endif
    ...
    @if ($newArrivalProducts->count() > 0)
        <div
            class="container-fluid mx-4 md:mx-0 bg-[#FFF1EB] md:mt-[50px] mt-[20px] md:py-[100px] py-[50px]  md:block">
