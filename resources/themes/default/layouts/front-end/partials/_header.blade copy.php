            ...
            <div class="container ">
                ...
                <div class="input-group-overlay mx-lg-4 search-form-mobile text-align-direction">
                    ...
                    <ul class="custom-dropdown-menu" id="categoryMenu">
                        ...
                        <li><a class="dropdown-item category-option" data-value="{{ $category['id'] }}" href="#">{{
                                $category['name'] }}</a></li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                            ...
                            <a class="dropdown-item" href="{{ route('customer.auth.logout') }}">{{ translate('logout')
                                }}</a>
                        </div>
                    </div>
                    @else
                    <div class="dropdown">
                        <a class="navbar-tool {{ Session::get('direction') === 'rtl' ? 'mr-md-3' : 'ml-md-3' }}"
                            ...
                            <span class="badge bg-danger">3</span> {{-- Example badge --}}
                        </a>
                    ...
                    <div class=" d-none d-lg-block">
                        ...
                        <div class="dropdown show mx-2 ">
                            <a class="btn  bg-light dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
            ...
            <div class="container px-10px">
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li
                            class="nav-item dropdown d-none d-md-block {{ request()->is('/') || request()->routeIs('home') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('home') }}#new-arrival-section">{{ translate('New
                                Arrivals') }}</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">{{ translate('brand')
                                }}</a>
                            <ul
                                ...
                                @php($brandIndex = 0)
                                @foreach (\App\Utils\BrandManager::getActiveBrandWithCountingAndPriorityWiseSorting() as
                                $brand)
                                @php($brandIndex++)
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul
                            ...
                            @if ($publishingHousesIndex < 10 && $publishingHouseItem['name'] !='Unknown' )
                                @php($publishingHousesIndex++) <li class="__inline-17">
                                <div>
                                    <a class="dropdown-item"
                    ...
                    @if ($businessMode == 'multi')
                    <li class="nav-item dropdown {{ request()->is('/') ? 'active' : '' }}">
                        <a class="nav-link text-capitalize" href="{{ route('vendors') }}">{{ translate('all_vendors')
                            }}</a>
                    </li>
                    @endif
                    ...
                    @if (getWebConfig(name: 'seller_registration'))
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">{{ translate('Vendor')
                            }}</a>
                        <ul
                            class="text-align-direction dropdown-menu __dropdown-menu-sizing dropdown-menu-{{ Session::get('direction') === 'rtl' ? 'right' : 'left' }} scroll-bar">
