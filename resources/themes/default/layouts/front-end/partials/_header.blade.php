...
@php($cartList=\App\Utils\CartManager::get_cart(type: 'checked'))
    ...
    <div class="container-fluid bg-[#ffffff]">
        <div class=" max-w-[100%] md:max-w-[100%] lg:md:max-w-[80%]   mx-auto justify-between items-center  text-sm  border-b">
    ...
    <div
        class="dropdown header-mobile-account-wrap header-account-control-wrap header-account-action-link header-account-style-icon">

        <a class="header-account-button dropdown-toggle d-inline-block text-decoration-none text-dark"
            href="#" id="mobileAccountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <span class="base-svg-iconsets">
                <svg class="thebase-svg-icon thebase-account-svg" fill="#000000"
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 64 64">
                    <title>Account</title>
                    <path
            ...
            @else
                <li>
                    <a class="dropdown-item" href="{{ route('customer.auth.login') }}">
                        <i class="fa fa-sign-in me-2"></i> {{ translate('customer_login') }}
                    </a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('vendor.auth.login') }}">
                        <i class="fa fa-user-circle me-2"></i> {{ translate('vendor_login') }}
                    </a>
                </li>
            @endif
        </ul>
    ...
    <form class="w-full" method="GET" action="{{ route('products') }}">
        <div class="flex border-2 shadow-sm rounded-lg relative">
            ...
            <button id="dropdown-button1" data-dropdown-toggle="dropdown1"
                ...
                type="button">
                {{ request('category') ? optional($categories->firstWhere('id', request('category')))->name : 'All Categories' }}
    ...
    @if (auth('customer')->check())
        ...
        <div class="dropdown">
            <a class="header-account-button dropdown-toggle d-inline-block text-decoration-none text-dark"
                href="#" id="customerMobileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="base-svg-iconsets">
                    <svg class="thebase-svg-icon thebase-account-svg" fill="#000000"
                        xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 64 64">
                        <title>Account</title>
                ...
                <small class="ms-1">{{ Str::limit(auth('customer')->user()->f_name, 10) }}</small>
            </a>

            <ul class="dropdown-menu dropdown-menu-{{ Session::get('direction') === 'rtl' ? 'start' : 'end' }}"
                aria-labelledby="customerMobileDropdown">
                <li>
                    <a class="dropdown-item" href="{{ route('account-oder') }}">
                        <i class="fa fa-shopping-bag me-2"></i> {{ translate('my_Order') }}
                    </a>
    ...
    @else
        ...
        <div class="dropdown">
            <a class="header-account-button dropdown-toggle d-inline-block text-decoration-none text-dark"
                href="#" id="guestMobileDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="base-svg-iconsets">
                    <svg class="thebase-svg-icon thebase-account-svg" fill="#000000"
                        xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 64 64">
                        <title>Account</title>
            ...
            <ul class="dropdown-menu dropdown-menu-{{ Session::get('direction') === 'rtl' ? 'start' : 'end' }}"
                aria-labelledby="guestMobileDropdown">
                <li>
                    <a class="dropdown-item" href="{{ route('customer.auth.login') }}">
                        <i class="fa fa-sign-in me-2"></i> {{ translate('customer_login') }}
                    </a>
                            ...
                            <ul
                                class="flex flex-col p-2 md:p-0  font-medium rounded-lg   rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                                    <li class="block py-2    rounded-sm md:bg-transparent">
                                        <a href="{{ url("/")}}"  class="   px-2">Home</a>
                                    </li>
                                    <li class="block py-2    rounded-sm md:bg-transparent">
                                        <a href="{{ url("product-filter")}}"  class=" px-2">Product Filter</a>
                                    </li>
                                    <li class="block py-2    rounded-sm md:bg-transparent">
                                        <a href="{{ url("product-details")}}"  class=" px-2">Product Detail</a>
                                    </li>
     ...
     <form class="w-full" method="GET" action="{{ route('products') }}">
        <div class="flex border-2 shadow-sm rounded-lg relative">
            ...
            <button id="dropdown-button" data-dropdown-toggle="dropdown"
                class="box_shadow_none shrink-0 z-30 inline-flex items-center py-2.5 px-4 text-[12px] font-medium text-[#504444] bg-white border-r border-gray-300 rounded-s-lg focus:outline-none"
                type="button">
                All Categories
            </button>
            ...
            <!-- Dropdown -->
            <div id="dropdown"
                class="z-40 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 hidden absolute left-0 top-full mt-1"
                aria-hidden="true">
    ...
    <div id="drawer-example"
        ...
        <div class=" ">
            <ul
                ...
                <li class="block py-2  border-b  rounded-sm md:bg-transparent">
                    <a href="{{ route('home') }}#new-arrival-section"  class="">{{ translate('New Arrivals') }}</a>
                </li>
                   @if ($web_config['featured_deals'] && count($web_config['featured_deals']) > 0)
                <li class="block py-2  border-b  rounded-sm md:bg-transparent">
                    <a href="{{ route('home') }}#featured_deal"  class="">{{ translate('Featured Deal') }}</a>
                </li>
              @endif
