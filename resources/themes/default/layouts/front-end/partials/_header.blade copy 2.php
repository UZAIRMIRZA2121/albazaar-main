        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-2 col-6 d-flex align-items-center">
                <a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="{{ route('home') }}">
                    <img src="{{ asset('images/albazar-logo.png') }}" class="img-fluid" style="max-height:60px;"
                        alt="logo" class="me-2 ">
                ...
                <a class="navbar-brand d-none d-sm-block me-3 flex-shrink-0" href="{{ route('home') }}">
                    <img class="img-fluid" style="max-height: 40px;"
                        src="{{ !empty($web_config['web_logo']) ? getStorageImages(path: $web_config['web_logo'], type: 'logo') : asset('images/albazar-logo.png') }}"
                ...
                <a class="navbar-brand d-sm-none" href="{{ route('home') }}">
                    <img class="img-fluid" style="max-height: 30px;"
                        src="{{ !empty($web_config['mob_logo']) ? getStorageImages(path: $web_config['mob_logo'], type: 'logo') : asset('images/albazar-logo.png') }}"
                        alt="{{ $web_config['company_name'] ?? 'Albazaar' }}">
                </a>
            </div>
            ...
            <div class="col-md-4">
                <form action="{{ route('products') }}" method="GET"
                    ...
                    <div class="dropdown category-dropdown">
                        <button class="btn btn-light border-0 px-3 d-flex align-items-center dropdown-toggle"
