...
<head>
    ...
    <link rel="stylesheet" media="screen" href="{{dynamicAsset(path: 'public/assets/front-end/css/theme.css?v1.0.1')}}">
</head>
<body>
    ...
    <div class="min-vh-100 row justify-content-between align-items-center maintenance-mode-container">
        <div class="col-12">
            <div class="text-center">
                <img class="object-fit-contain height-300px" src="{{ dynamicAsset(path: 'public/assets/front-end/img/maintenance-mode-icon.png') }}" alt="{{ translate('maintenance') }}">
            </div>
