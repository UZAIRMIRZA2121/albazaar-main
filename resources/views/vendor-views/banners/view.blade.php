                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <input type="hidden" id="promotion_type" name="promotion_id" value="{{$promotion->id}}">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="banner_type" name="banner_type" class="form-control"
                                                id="banner_type" disabled value="{{ $promotion->promotion_type }}">
                                        ...
                                        <div class="form-group mb-3 col-md-12">
                                            <label for="name"
                                                class="title-color text-capitalize">{{ translate('banner_URL') }}</label>
                                            <input type="url" name="url" class="form-control" id="url"
                                                required placeholder="{{ translate('Enter_url') }}">
                                        </div>
                                        ...
                                        <div class="form-group mb-0 col-md-12" id="resource-product">
                                        ...
                                        <div class="form-group mb-0 d--none col-md-12" id="resource-category">
                                            <label for="name"
                                        ...
                                        <div class="form-group mb-0 d--none col-md-12" id="resource-shop">
                                        ...
                                        <div class="form-group mb-0 d--none col-md-12" id="resource-brand">
                                            <label for="brand_id"
