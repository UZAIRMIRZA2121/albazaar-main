        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-wrapper-right">
                <div class="auth-wrapper-form">
                    ...
                    <form id="form-id" action="{{ route('vendor.auth.login') }}" method="post"
                        id="admin-login-form">
                        @csrf
                        <div>
                            <div class="mb-5">
                        ...
                        @else
                            <div class="row p-2">
                                <div class="col-6 pr-0">
                                    <input type="text"
                                        class="form-control form-control-lg form-control-focus-none h-50px"
                                        id="vendor-login-recaptcha-input" name="vendorRecaptchaKey" value=""
                                        required placeholder="{{ translate('enter_captcha_value') }}">
                                </div>
                                <div class="col-6 input-icons bg-white rounded">
                                    <a class="get-login-recaptcha-verify cursor-pointer get-session-recaptcha-auto-fill"
                                        ...
                                        <img src="{{ URL('/vendor/auth/recaptcha/1?captcha_session_id=vendorRecaptchaSessionKey') }}"
                                            class="input-field w-90 h-50px img-fit p-0 rounded"
