                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        @if (isset($statusHistory) && count($statusHistory) > 0)
                            <div class="mt-4">
                                <h5 class="text-uppercase mb-3">{{ translate('Order Status History by Tryotto') }}</h5>
                                @foreach ($statusHistory as $history)
                                    <div class="reference-code d-flex flex-column gap-1 mb-2">
                                        <div>
                                            <span class="title-color">{{ translate('Status') }}:</span>
                                            <strong>{{ ucfirst($history['status']) }}</strong>
                                        </div>
                                        <div>
                                            <span class="title-color">{{ translate('Description') }}:</span>
                                            <strong>{{ $history['description'] }}</strong>
                                        </div>
                                        <div>
                                            <span class="title-color">{{ translate('Date') }}:</span>
                                            <strong>{{ \Carbon\Carbon::parse($history['date'])->format('d M Y, h:i A') }}</strong>
                                        </div>
                                    </div>
                                    <hr>
                                @endforeach
                                    ...
                                    @if (isset($order->deliveryMan))
                                        ...
                                        <li class="choose_delivery_man mt-3">
                                            ...
                                            <input type="date" value="{{ $order->expected_delivery_date }}"
                                                ...
                                                id="expected_delivery_date" class="form-control deliveryDateUpdate"
                                                required>
                                        </li>
                                    @endif
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header justify-content-center pt-0 pb-0">
                    <h3 class="modal-title" id="locationModalLabel">{{ translate('location_data') }}</h3>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 rounded border p-3">
                            <div class="h3 text-cyan-blue text-center">{{ translate('order') }} #{{ $order->id }}
                            </div>
