                    ...
                    <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="brand_id">
                                        <option value="{{ null }}" selected>{{ translate('select_Brand') }}
                                        </option>
                        ...
                        {{-- <div class="col-md-6 col-lg-2 col-xl-2 physical_product_show">
                            <div class="form-group">
                                ...
                                <div class="ml-5">
                                    <input type="radio" name="refundable" value="1" class="form-check-input"
                                        id="refundableYes" checked>
                                    <label for="refundableYes">{{ translate('Yes') }}</label>
                                    <br>
                                    <input type="radio" name="refundable" value="0" class="form-check-input"
                                        id="refundableNo">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="d-flex gap-3">
                                    <input type="radio" id="ready_made" name="availability" value="ready_made" checked>
                                    <label for="ready_made">{{ translate('Ready Made') }}</label>
                        
                                    <input type="radio" id="manufacture_days" name="availability" value="manufacture_days">
                        ...
                        <div class="col-md-3" id="menufacture_days_input" style="display: none;">
                            <div class="form-group">
                                <label for="manufacture_days">{{ translate('Manufacture Days') }}</label>
                                <input type="text" class="form-control mt-2" placeholder="{{ translate('Manufacture Days') }}" name="menufacture_days">
                            </div>
                        </div>
                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 d-none">
                            <div class="form-group">
                                ...
                                <input type="hidden" min="0" step="0.01" name="tax" id="tax"
                                    readonly value="{{ $commission->tax_percentage }}" class="form-control">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 d-none">
                            <div class="form-group">
                                ...
                                <input type="hidden" min="0" step="0.01" name="tax_model" id="tax_model"
                                    readonly value="include" class="form-control">
