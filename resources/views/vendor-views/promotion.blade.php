                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('vendor.push-notification.index', $promotion->id) }}" class="btn btn-warning">Select</a>
                                    @elseif($promotion->promotion_type == 'Main Section Banner' || $promotion->promotion_type == 'Footer Banner')
                                    <a href="{{ route('vendor.banner.index', $promotion->id) }}" class="btn btn-warning">Select</a>
                                    @elseif($promotion->promotion_type == 'Promote product in category page' )
                                    <a href="{{ route('vendor.featured-product.index', $promotion->id) }}" class="btn btn-warning">Select</a>
