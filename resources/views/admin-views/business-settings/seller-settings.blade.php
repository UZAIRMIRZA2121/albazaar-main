                    ...
                    <div class="row align-items-end">
                        ...
                        <div class="col-xl-2 col-md-2">
                            <div class="form-group">
                                ...
                                @php($sales_commission_first_percentage=getWebConfig('sales_commission_first_percentage'))
                                <input type="number" class="form-control" name="commission_first_percentage"
                                       value="{{$Commission->commission_first_percentage ?? 0}}"
                        ...
                        <div class="col-xl-2 col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="commission_second_percentage"
                                       value="{{$Commission->commission_second_percentage ?? 0}}"
                                       placeholder="{{ translate('ex').':'.'70'}}" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <label class="title-color d-flex">
                                ...
                                <span class="input-label-secondary cursor-pointer" data-toggle="tooltip"
                                      data-placement="right"
                                      title="{{ translate('set_how_vendors_recover_their_forgotten_passwords') }}">
                                <img width="16" src="{{dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')}}"
                                     alt="">
                            </span>
                            </label>
