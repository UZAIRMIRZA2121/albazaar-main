                ...
                <div class="d-flex gap-3 flex-wrap flex-lg-nowrap">
                    ...
                    <div class="row gy-3 flex-grow-1 w-100">
                        ...
                        <div class="col-xxl-12">
                            <div class="bg-light p-3 border border-primary-light rounded">
                                <h4 class="mb-3 text-capitalize">Basic Information</h4>

                                <div class="d-flex gap-5">
                                    <div class="pair-list">
                                        <div>
                                            <span class="key text-nowrap">Registration Type</span>
                                            <span class="px-2">:</span>
                                            <span class="value ">{{ $seller['radio_check'] ?? translate('no_data_found') }}</span>
                                        </div>

                                        <div>
                                            <span class="key text-nowrap">Business</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['business_day'] ?? translate('no_data_found') }}</span>
                                        </div>
                                        <div>
                                            <span class="key text-nowrap"> Establishment</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['establishment'] ?? translate('no_data_found') }}</span>
                                        </div>

                                        <div>
                                            <span class="key text-nowrap">City</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['city'] ?? translate('no_data_found') }}</span>
                                        </div>
                                        <div>
                                            <span class="key text-nowrap">Shop Address</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['shop_address'] ?? translate('no_data_found') }}</span>
                                        </div>
                                    </div>
                                    <div class="pair-list">
                                       
                                        <div>
                                            <span class="key text-nowrap">Latitude</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['latitude'] ?? translate('no_data_found') }}</span>
                                        </div>
                                        <div>
                                            <span class="key text-nowrap">Longitude</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['longitude'] ?? translate('no_data_found') }}</span>
                                        </div>
                                        <div>
                                            <span class="key text-nowrap">Category</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['category'] ?? translate('no_data_found') }}</span>
                                        </div>
                                        <div>
                                            <span class="key text-nowrap">About</span>
                                            <span class="px-2">:</span>
                                            <span class="value">{{ $seller['brief_here'] ?? translate('no_data_found') }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
